...
int32_t test_register_hdmicec_hal_sink_l3_tests(void)
{
    ...
    UT_add_test( pSuite, "Transmit CEC Command", test_l3_hdmi_cec_sink_hal_TransmitHdmiCecCommand);
    UT_add_test( pSuite, "Get Phyiscal Address", test_l3_hdmi_cec_sink_hal_GetPhysicalAddress);
    UT_add_test( pSuite, "Remove Logical Address", test_l3_hdmi_cec_sink_hal_RemoveLogicalAddress);
    UT_add_test( pSuite, "Close HDMI CEC", test_l3_hdmi_cec_sink_hal_Close);
