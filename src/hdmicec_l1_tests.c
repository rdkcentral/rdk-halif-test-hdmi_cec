 ...
 * |07|call HdmiCecSetTxCallback(handle, DriverTransmitCallback, 0)  - call the API, after module is closed | handle, DriverTransmitCallback, data address | HDMI_CEC_IO_INVALID_STATE| Should Pass |
 * |08|call HdmiCecSetTxCallback(0, DriverTransmitCallback, 0)  - call the API, after module is closed with invalid handle | handle=0, DriverTransmitCallback, data address | HDMI_CEC_IO_INVALID_STATE| Should Pass | 
 */
void test_hdmicec_hal_l1_setTxCallback( void )
{
    ...
    result = HdmiCecSetTxCallback( 0, DriverTransmitCallback, 0 );
    UT_ASSERT_EQUAL( result, HDMI_CEC_IO_INVALID_STATE );
}
