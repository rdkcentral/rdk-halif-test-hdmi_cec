 ...
 */
int test_l3_hdmi_cec_driver_register ( char* validation_profile )
{
	...
	UT_add_test( pSuite, "test_l3_sink_image_view_on" ,test_l3_sink_image_view_on );
    UT_add_test( pSuite, "test_l3_sink_text_view_on" ,test_l3_sink_text_view_on );
