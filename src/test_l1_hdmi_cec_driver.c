 ...
 * |Variation / Step|Description|Test Data|Expected Result|Notes|
 * |:--:|---------|----------|--------------|-----|
 * |01|Call HdmiCecAddLogicalAddress() - trying to add logical address even before opening the module | handle, logicalAddress | HDMI_CEC_IO_NOT_OPENED for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |02|Call HdmiCecOpen() - open interface | handle | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |03|Call HdmiCecAddLogicalAddress() - call with invalid handle | handle=0, logicalAddress | HDMI_CEC_IO_INVALID_HANDLE for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |04|Call HdmiCecAddLogicalAddress() - call with invalid logical address | handle, logicalAddress=-1 | HDMI_CEC_IO_INVALID_ARGUMENT for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |05|Call HdmiCecAddLogicalAddress() - call with invalid logical address | handle, logicalAddress=0x10 | HDMI_CEC_IO_INVALID_ARGUMENT for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |06|Call HdmiCecClose() - close interface | handle=hdmiHandle | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |07|Call HdmiCecAddLogicalAddress() - call after module is closed | handle, logicalAddress | HDMI_CEC_IO_NOT_OPENED for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 *
 ...
 * |:--:|---------|----------|--------------|-----|
 * |01|Call HdmiCecOpen() - open interface | handle | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |02|Call HdmiCecAddLogicalAddress() - call with valid arguments. API is applicable only for sink devices  | handle, logicalAddress | HDMI_CEC_IO_SUCCESS for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass for sink devices |
 ...
 * |Variation / Step|Description|Test Data|Expected Result|Notes|
 * |:--:|---------|----------|--------------|-----|
 * |01|Call HdmiCecRemoveLogicalAddress() - trying to remove logical address even before opening the module | handle, logicalAddress | HDMI_CEC_IO_NOT_OPENED for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |02|Call HdmiCecOpen() - open interface | handle | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |03|Call HdmiCecRemoveLogicalAddress() - call with invalid handle | handle=0, logicalAddress | HDMI_CEC_IO_INVALID_HANDLE for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |04|Call HdmiCecRemoveLogicalAddress() - call with invalid logical address | handle, logicalAddress=0x10 | HDMI_CEC_IO_INVALID_ARGUMENT for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |04|Call HdmiCecRemoveLogicalAddress() - call with invalid logical address | handle, logicalAddress=-1  | HDMI_CEC_IO_INVALID_ARGUMENT for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |05|Call HdmiCecRemoveLogicalAddress() - Try to remove with out adding the logical address| handle, logicalAddress | HDMI_CEC_IO_NOT_ADDED for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |06|Call HdmiCecAddLogicalAddress() - call with valid arguments | handle, logicalAddress | HDMI_CEC_IO_SUCCESS for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |07|Call HdmiCecRemoveLogicalAddress() - remove allocated logical address.  | handle, logicalAddress | HDMI_CEC_IO_SUCCESS for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass|
 * |08|Call HdmiCecRemoveLogicalAddress() - remove same logical address again. | handle, logicalAddress | HDMI_CEC_IO_NOT_ADDED for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |09|Call HdmiCecClose() - close interface | handle=hdmiHandle | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |10|Call HdmiCecRemoveLogicalAddress() - call after module is closed | handle, logicalAddress | HDMI_CEC_IO_NOT_OPENED for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 */
 ...
 * |:--:|---------|----------|--------------|-----|
 * |01|Call HdmiCecOpen() - open interface | handle | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |02|Call HdmiCecAddLogicalAddress() - call with a valid logical address | handle, logicalAddress | HDMI_CEC_IO_SUCCESS for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass |
 * |03|Call HdmiCecRemoveLogicalAddress() - remove allocated logical address. This API is only applicable for sink devices. | handle, logicalAddress | HDMI_CEC_IO_SUCCESS for sink device and HDMI_CEC_IO_OPERATION_NOT_SUPPORTED for source device| Should Pass|
 * |04|Call HdmiCecClose() - close interface | handle=hdmiHandle | HDMI_CEC_IO_SUCCESS| Should Pass |
 *
 */
 ...
 * |:--:|---------|----------|--------------|-----|
 * |01|Call HdmiCecOpen() - open interface | handle | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |02|Call HdmiCecTx() - send the cec message with direct address and other valid arguments after module initialization | handle, buf, len, &ret | HDMI_CEC_IO_SUCCESS and ret=HDMI_CEC_IO_SENT_BUT_NOT_ACKD| Should Pass |
 * |03|Call HdmiCecTx() - send the cec message with broadcast address and other valid arguments after module initialization | handle, buf, len, &ret | HDMI_CEC_IO_SUCCESS | Should Pass |
 * |04|Call HdmiCecClose() - close interface | handle=hdmiHandle | HDMI_CEC_IO_SUCCESS| Should Pass |
 */
 ...
 * |:--:|---------|----------|--------------|-----|
 * |01|Call HdmiCecOpen() - open interface | handle | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |02|Call HdmiCecTx() - send the cec direct addressing message with valid arguments after module initialization | handle, buf, len, &ret | HDMI_CEC_IO_SUCCESS and ret=HDMI_CEC_IO_SENT_BUT_NOT_ACKD| Should Pass |
 * |03|Call HdmiCecTx() - send the cec broadcasting message with valid arguments after module initialization | handle, buf, len, &ret | HDMI_CEC_IO_SUCCESS| Should Pass |
 * |04|Call HdmiCecClose() - close interface | handle=hdmiHandle | HDMI_CEC_IO_SUCCESS| Should Pass |
 */
